...
$routes->get('consultar_producto2', 'Home::consultar_producto2');
...
/*Rutas de registro de producto*/
$routes->get('/agregar_producto', 'producto_controller::create');
$routes->post('/enviar-producto', 'producto_controller::formValidation');

/*Rutas de consulta de producto*/
/*$routes->get('/consultar-producto', 'productos');*/
